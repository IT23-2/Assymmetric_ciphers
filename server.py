import socket  # Импорт модуля для работы с сетевыми сокетами (для создания сетевых соединений)Add commentMore actions
...
server_socket.close()Add commentMore actions
