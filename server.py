import socket
import pickle
from Crypto.PublicKey import RSAAdd commentMore actions
...
K = A ** b % p
print("Shared secret K =", K)Add commentMore actions
...
print(f"Decrypted message: {decrypted_message.decode()}")Add commentMore actions
